...
/************* Idioma  ***************/
$lang[$plugin.'description']    = 'Evita cualquier copia de temas.';
$lang[$plugin.'Measure'] = 'Rango de copia: <span class="text-info">0%=Cualquier coincidencia cercana - 100%=Spam idéntico</span>';
?>